const translations = {
  en: {
    ...
    extraBigKnifeAndGadgets: "Extra Big Knives and Gadgets",
    chefKnife: '8" chef knife',
    santokuKnife: '8" santoku knife',
    breadKnife: '8" bread knife',
    chopperKnife: '7" meat chopper cleaver',
    chopper: '7" meat chopper cleaver',
    utilityKnife: '5" utility knife',
    paringKnife: '3" paring knife',
    choppingBoard: "#3 way wood fiber cutting board",
    tongs: "#1 silicone food tongs",
    scissors: "#3 hole scissors",
    turner: "#1 silicone turner",
    // product list end //
    textLabel: "Text:",
