const translations = {
  en: {
    ...
    // product list end //
    textLabel: "Text:",
    textPlaceholder: "Enter engraving content",
    fontLabel: "Font:",
    weightLabel: "Weight:",
    regularWeight: "Regular",
    boldWeight: "Bold",
    heavyWeight: "Heavy",
    sameContentLabel: "Use same content for all items",
    ...
    resizeControlsOn: "ON: Shows corner handles to resize text by dragging.",
    ...
    autoAlignOn: "Keeps text position aligned across all items on the same page.",
  ...
  "zh-hk": {
    ...
    // product list end //
    textLabel: "文字：",
    textPlaceholder: "輸入刻字內容",
    fontLabel: "字體：",
    weightLabel: "字體粗幼：",
    regularWeight: "普通",
    boldWeight: "粗體",
    heavyWeight: "特粗",
    sameContentLabel: "所有產品使用相同內容",
    instructions: "• 拖動文字以移動。<br>• 拖動調整手柄以縮放（桌面）。<br>• 捏合以縮放和移動文字（手機）。",
    editZone: "編輯區域",
    resizeControls: "調整控制",
    syncFonts: "同步字體",
    autoAlignment: "自動對齊",
    ...
    editZoneOn: "開：顯示刻字區域，指引文字放置。",
    editZoneOff: "關：隱藏刻字區域，以更清晰地查看產品。",
    resizeControlsGuide: "顯示調整手柄",
    resizeControlsOn: "開：顯示調整手柄，可拖動調整文字大小。",
    resizeControlsOff: "關：隱藏調整手柄，保持文字可編輯但視圖更簡潔。",
    syncFontsGuide: "同步文字樣式",
    syncFontsOn: "開：同步同頁的字型和大小。",
    syncFontsOff: "關：允許每件產品使用不同的字型和大小。",
    autoAlignGuide: "自動對齊文字",
    autoAlignOn: "開：保持同頁產品的文字位置對齊。",
